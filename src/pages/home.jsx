          ...
          {blockHash !== '' ? (
            <Card className="text-md opacity-90">
              ...
              <p>
                ...
                {(currentReward * price?.usd) / 1.0}). The reward consisted of a base reward of {ether(block[0]?.fee)}{' '}
                BTC ($
              ...
              <p>
                ...
                {(ether(totalCount) / block[0]?.n_tx / 1) * (price?.usd / 1).toFixed(2).toString()}). Learn more about
                how blocks work.
              </p>
            </Card>
          ) : (
